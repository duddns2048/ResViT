...
class UnalignedDataset_unified(BaseDataset):
    def initialize(self, opt):
        ...
        # print(f'source: {self.modality1_paths[0]}' if self.avail_fn[0]==1 else f'target: {self.modality1_paths[0]}')
        # print(f'source: {self.modality2_paths[0]}' if self.avail_fn[1]==1 else f'target: {self.modality2_paths[0]}')
        # print(f'source: {self.modality3_paths[0]}' if self.avail_fn[2]==1 else f'target: {self.modality3_paths[0]}')
        # print(f'source: {self.modality4_paths[0]}' if self.avail_fn[3]==1 else f'target: {self.modality4_paths[0]}')
