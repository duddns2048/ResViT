...
if __name__ == "__main__":
    ...
    exp_name_list = [
                ('BraSyn_unified_3_to_1_fold0_finetune_H10_case50', 't1c'),
                ('BraSyn_unified_3_to_1_fold0_finetune_H10_case50', 't1n'),
                ('BraSyn_unified_3_to_1_fold0_finetune_H10_case50', 't1f'),
                ('BraSyn_unified_3_to_1_fold0_finetune_H10_case50', 't1w'),
                ]
    folds_list = [0]
    modality_list = ["t1c"]
