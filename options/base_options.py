...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--G_only_L1', action='store_true', help='if specified, G_loss = L1 | else G_loss = GAN_loss + L1_loss')
        self.parser.add_argument('--avail_fn', type=str, help='availability function in paper, 0: target, 1: source')
