...
if __name__ == "__main__":
    ...
    exp_name_list = [
                # ('BraSyn_unified_3_to_1_fold0_pretrain_H100_prove', 't1c'),
                # ('BraSyn_unified_3_to_1_fold0_pretrain_H100_prove', 't1n'),
                ('BraSyn_unified_3_to_1_fold0_pretrain_H100_prove', 't2w'),
                ('BraSyn_unified_3_to_1_fold0_pretrain_H100_prove', 't2f'),
